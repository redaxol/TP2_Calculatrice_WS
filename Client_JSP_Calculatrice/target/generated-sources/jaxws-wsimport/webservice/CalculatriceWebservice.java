 ...
 * 
 */
@WebService(name = "Calculatrice_Webservice", targetNamespace = "http://webservice/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CalculatriceWebservice {
    ...
    @Action(input = "http://webservice/Calculatrice_Webservice/helloRequest", output = "http://webservice/Calculatrice_Webservice/helloResponse")
    public String hello(
    ...
    @Action(input = "http://webservice/Calculatrice_Webservice/AdditionRequest", output = "http://webservice/Calculatrice_Webservice/AdditionResponse")
